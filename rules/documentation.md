...
文章規範の各節 (「整形」〜「見出しの付け方」) の原典: [日本語技術文書の文章規範](https://gist.github.com/k16shikano/fd287c3133457c4fd8f5601d34aa817d)。原文をそのまま借用し、書籍原稿に固有の規範 (一文一行、脚注、語り・演出の管理など) を落としている。「ADR の構成」は本リポジトリ独自の規約。
